define(["sugar-web/env", "l10n"], function (env, l10n) {
  ...
  function onSharedActivityUserChanged(msg) {
    ...
    if (msg.move === 1) {
      PaintApp.libs.humane.log(html + l10n.get("PlayerJoin",{user: userName}))
    }

    if (msg.move === -1) {
      PaintApp.libs.humane.log(html + l10n.get("PlayerLeave",{user: userName}))
    }
